...
In most cases (such as while [[#Travel|Travelling]]) it is entirely reasonable to perform a [Exploration Activity]( https://2e.aonprd.com/Traits.aspx?ID=595 ) during a Hexploration Activity. When doing such an activity would mention your movement speed being halved, the Hexploration Activity cost is doubled.
...
> - [Detect Magic]( https://2e.aonprd.com/Actions.aspx?ID=2624 )
...
> - [Track]( https://2e.aonprd.com/Actions.aspx?ID=2408 )
...
### [Travel]( https://2e.aonprd.com/Actions.aspx?ID=476 )
Travelling costs a number of [[#Hexploration Activities (HA)]] equal to the [[#^TerrainTable|Terrain Difficulty]]. The difficulty of the terrain is decided by the environment (e.g. Forests are difficult terrain, Mountains could be very difficult). Moving along a road moves it down 1 degree of difficulty, having bad conditions (like weather) could move it up 1 or 2.

Travelling through an area will require a [Sense Direction]( https://2e.aonprd.com/Actions.aspx?ID=2406 )[^1] check unless you're following a road or some other "obvious" direction. When the scenario changes significantly or for another reason, multiple checks might be required or a different action like a [Track]( https://2e.aonprd.com/Actions.aspx?ID=2408 ) check[^2].

### [Reconnoiter]( https://2e.aonprd.com/Actions.aspx?ID=477 )
Reconnoitering a hex will reveal it on the hex-map[^3] (effectively mapping it, which will earn you 10 sp/p with [[Eratosthenes|Prof. Eratosthenes]]). It costs a number of [[#Hexploration Activities (HA)]] equal to the [[#^TerrainTable|Terrain Difficulty]], possibly made 1 or 2 steps more difficult by circumstances such as weather.

### [Fortify Camp]( https://2e.aonprd.com/Actions.aspx?ID=478 )
...
[^2]: Tracking is a [[#Exploration Activities|Exploration Activity]] that would halve your speed and thus double the [[#Hexploration Activities|HA]] cost
